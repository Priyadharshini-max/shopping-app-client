                        ...
                        return (
                            <Col key={index}>
                                <Card>
                                    ...
                                    <Card.Footer>
                                        <Link to="/ProductDetails"><Button type="button" size="sm" onClick={() => context.HandleBuyNowCard(item)}>ProductDetails</Button></Link>
                                        <Button variant="secondary" size="sm" disabled={checkdisable(item)} onClick={() => context.HandleAddCardFn(item)}>{item.addCard}</Button>
                                    </Card.Footer>
                                </Card>
                            </Col>
                        )
